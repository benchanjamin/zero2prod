...
pub async fn publish_newsletter(
    ...
    // Insert statement into database, or select if it already exists (conflict)
    ...
    //
    // // Retrieve the saved response if it exists
    ...
    // Update the response into the database, and return it
