...
pub async fn spawn_app() -> TestApp {
    ...
    Lazy::force(&TRACING);
    // No need to init subscriber here, TRACING already does that.
    ...
    let configuration = {
        ...
        // This overrides the base_url in the configuration file which is localhost and provides localhost:{port} where port is a random number
        c.email_client.base_url = email_server.uri();
        c
    };

    // Used to be the old way of creating a connection pool
...
impl TestApp {
    ...
    //     // Old way of creating a test user
    ...
    {
        self.api_client
            // Don't want any redirection to be handled from the test client
...
impl TestUser {
    // New way of creating a test user
